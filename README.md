...
Runs on `http://localhost:5077` by default. Swagger UI available at `http://localhost:5077/swagger`.
...
Runs on `http://localhost:4200`. The API base URL is set in `frontend/src/environments/environment.ts` (defaults to `http://localhost:5077/api`).
